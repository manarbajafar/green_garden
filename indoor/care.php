...
<header>
    ...
    <main>
        ...
        <div id="main-div">
            ...
            <!--  indoor careLevel image and label -->
        ...
        <div id="easy_plants" class="easy_plants ">
        ...
        <div id="neddscar-plants" class="neddscar-plants ">
    ...
    <script type="text/javascript">
        function easy_plants() {
            document.getElementById('easy_plants').style.display = 'block'

            document.getElementById('neddscar-plants').style.display = 'none'

            document.getElementById('all-plants').style.display = 'none'
        }

        function need_plants() {
            document.getElementById('easy_plants').style.display = 'none'

            document.getElementById('neddscar-plants').style.display = 'block'
