...
<header>
    ...
    <main>
        ...
        <div id="main-div">
            ...
            <!-- sections icons -->
            <div id="icons" style="width: 55%;">
                <div class="iconscontainer indoor-icons " onclick="tall_plants()">
                    <img src="../img/tall-icon.png "  alt="The image dose not appear ,possibilty because of slow connection"  class="imgs ">
                    <div class="hovering">
                        <div class="section-name">Tall</div>
                    </div>
                </div>
                <div class=" iconscontainer indoor-icons " onclick="medium_plants()">
                    <img src="../img/medium-icon.png " alt="The image dose not appear ,possibilty because of slow connection"  class="imgs ">
                    <div class="hovering">
                        <div class="section-name">Medium</div>
                    </div>
                </div>
                <div class=" iconscontainer indoor-icons " onclick="small_plants()">
                    <img src="../img/small-icon.png "  alt="The image dose not appear ,possibilty because of slow connection"  class="imgs ">
                    <div class="hovering">
                        <div class="section-name">Small</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div id="meduim-plants" class="meduim-plants ">
            <h3 class="section-label ">Meduim plants</h3>
            <br>
            <div class="products-section">
                <br>
                <div class="product">
        ...
        <div id="small-plants" class="small-plants ">
            <h3 class="section-label ">Small plants</h3>
            <br>
            <div class="products-section">
                <br>
                <div class="product">
    ...
    <script type="text/javascript">
        function tall_plants() {
            document.getElementById('tall-plants').style.display = 'block'

            document.getElementById('meduim-plants').style.display = 'none'

            document.getElementById('small-plants').style.display = 'none'
        }

        function medium_plants() {
            document.getElementById('tall-plants').style.display = 'none'

            document.getElementById('meduim-plants').style.display = 'block'

            document.getElementById('small-plants').style.display = 'none'
        }

        function small_plants() {
            document.getElementById('tall-plants').style.display = 'none'

            document.getElementById('meduim-plants').style.display = 'none'

            document.getElementById('small-plants').style.display = 'block'
        }
