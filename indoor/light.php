...
<header>
    ...
    <main>
        ...
        <div id="main-div">
            ...
            <div id="outdoor-light-img" onclick="all_plants()">
            ...
            <!-- sections icons -->
            <div id="icons" style="width: 23%;">
                <div class="iconscontainer indoor-icons " onclick="light_plants()">
                    <img src="../img/indoor-light.png "  alt="The image dose not appear ,possibilty because of slow connection"  class="imgs ">
                    <div class="hovering">
                        <div class="section-name">Light</div>
                    </div>
                </div>
                <div class=" iconscontainer indoor-icons " onclick="shade_plants()">
                    <img src="../img/indoor-shade.png "  alt="The image dose not appear ,possibilty because of slow connection"  class="imgs ">
                    <div class="hovering">
        ...
        <div id="light-plants" class="light-plants ">
            <h3 class="section-label ">Light plants</h3>
            <br>
    ...
    <script type="text/javascript">
        function light_plants() {
            document.getElementById('light-plants').style.display = 'block'
        ...
        function shade_plants() {
            document.getElementById('light-plants').style.display = 'none'
