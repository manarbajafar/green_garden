...
<header>
    ...
    <main>
        ...
        <div id="main-div">
            ...
            <div id="outdoor-light-img">
                <img src="../img/section.png" style="width: 100%;">
                <h1 id="page-label">Plants Size</h1>

            </div>

            <!-- sections icons -->
            <div id="icons" style="width: 24%;">
                <div class="iconscontainer outdoor-icons" id="short">
                    <img src="../img/z1.png " class="imgs">
                    <div class="hovering">
                        <div class="section-name">Short</div>
                    </div>
                </div>
                <div class=" iconscontainer outdoor-icons" id="tall">
                    <img src="../img/z2.png " class="imgs">
                    <div class="hovering">
                        <div class="section-name">Tall</div>
                    </div>
                </div>
            </div>
        ...
        <!-- end of main div-->
        <div id="tall-plants" class="tall-plants">
            <h3 class="section-label">Tall Plants</h3>
            <br>
            <div class="products-section">
                ...
                <div class="product">
                    ...
                    <div class="display">
                        <img class="item-img" src="../img/strlizia.png">
                ...
                <div class="product">
                    <div class="display">
                        ...
                        <img class="item-img" src="../img/bougainvillea.png">
            ...
            <div class="products-section">
                ...
                <div class="product">
                    <div class="display">
                        ...
                        <img class="item-img" src="../img/cupressaceae.png">
        ...
        <div id="short-plants" class="short-plants">
            <h3 class="section-label">Short Plants</h3>
            <br>
            <div class="products-section">
                <br>
                <div class="product">
                    ...
                    <div class="display">
                        ...
                        <img class="item-img" src="../img/anemone.png">
                ...
                <div class="product">
                    ...
                    <div class="display">
                        <img class="item-img" src="../img/lavandula.png">
                ...
                <div class="product">
                    <div class="display">
                        <img class="CannaIndica item-img" src="../img/canna.png">
            ...
            <div class="products-section">
                ...
                <div class="product">
                    <div class="display">
                        ...
                        <img class="item-img" src="../img/dutchrose.png">
                ...
                <div class="product">
                    <div class="display">
                        ...
                        <img class="item-img" src="../img/lemon.png">
                ...
                <div class="product">
                    <div class="display">
                        ...
                        <img class="item-img" src="../img/Laura.png" style="width: 60%;">
            ...
            <div class="products-section">
                ...
                <div class="product">
                    <div class="display">
                        ...
                        <img class="item-img" src="../img/twist.png" style="width: 60%;">
                ...
                <div class="product">
                    <div class="display">
                        ...
                        <img class="item-img" src="../img/buxus.png">
                ...
                <div class="product">
                    <div class="display">
                        ...
                        <img class="item-img" src="../img/funcky.png">
    ...
    <footer class="footerparts ">
        <div class="bg">
            ...
            <div id="icons" style="width: 40%;">
                ...
                <div class=" iconscontainer footericonscontainer">
                    <img src="../img/inst.png " width="60%">
                </div>
                <div class=" iconscontainer footericonscontainer">
                    <img src="../img/twitter.png " width="55%">
                </div>
            </div>
        </div>
        <img class="imgfooter" src="../img/casual-life-3d-likes.png" height="40%" width="60%">
    ...
    <script type="text/javascript">
        document.getElementById("short").onclick = function() {
            ...
            document.getElementById("tall-plants").style.display = "none";
            document.getElementById("short-plants").style.display = "block";

        }

        document.getElementById("tall").onclick = function() {

            document.getElementById("short-plants").style.display = "none";
            document.getElementById("tall-plants").style.display = "block";
