...
<header>
    ...
    <main>
        ...
        <div id="main-div">
            ...
            <div id="icons" style="width: 40%;">
                <div class="iconscontainer " id="doorstep">
                    <img src="../img/doorstep1.png "  alt="The image dose not appear ,possibilty because of slow connection" class="imgs">
                    <div class="hovering">
                        <div class="section-name">Doorstep</div>
                    </div>
                </div>
                <div class=" iconscontainer " id="garden">
                    <img src="../img/Garden1.png "  alt="The image dose not appear ,possibilty because of slow connection"  class="imgs">
                    <div class="hovering">
                        <div class="section-name">Garden</div>
                    </div>
                </div>
                <div class="iconscontainer" id="windowsill">
                    <img src="../img/windowsill1.png"   alt="The image dose not appear ,possibilty because of slow connection" class="imgs">
                    <div class="hovering">
                        <div class="section-name">Windosill</div>
                    </div>
                </div>
                <div class="iconscontainer" id="balcony">
                    <img src="../img/balcony1.png "  alt="The image dose not appear ,possibilty because of slow connection" class="imgs ">
                    <div class="hovering">
                        <div class="section-name" id="balc">Balcony</div>
                    </div>
                </div>
            </div>
        ...
        <!-- end of main div-->
        <div id="doorstep-plants" class="doorstep-plants">
            <h3 class="section-label">Doorstep Plants</h3>
            <br>
        ...
        <div id="garden-plants" class="garden-plants">
            <h3 class="section-label">Garden Plants</h3>
            <br>
            <div class="products-section">
                <br>
                <div class="product">
                    ...
                    <div class="display">
                        ...
                        <h1 class="plant-name" style="font-size: 1.1em;">Strelizia Nicolai</h1>
                ...
                <div class="product">
                    ...
                    <div class="display">
                        <img class="item-img"   alt="The image dose not appear ,possibilty because of slow connection" src="../img/تيكوما.png">
        ...
        <div id="windowsill-plants" class="windosill-plants">
            <h3 class="section-label">Windosill plants</h3>
            <br>
            <div class="products-section">
                <br>
            ...
            <div class="products-section">
                ...
                <div class="product">
                    <div class="display">
                        <img class="item-img"  alt="The image dose not appear ,possibilty because of slow connection" src="../img/canna.png">
        ...
        <div id="balcony-plants" class="balcony-plants">
            <h3 class="section-label">Balcony plants</h3>
            <br>
            <div class="products-section">
                <br>
                <div class="product">
    ...
    <script type="text/javascript">
        document.getElementById("garden").onclick = function() {
            ...
            document.getElementById("windowsill-plants").style.display = "none";
            document.getElementById("doorstep-plants").style.display = "none";
            document.getElementById("balcony-plants").style.display = "none";
            document.getElementById("garden-plants").style.display = "block";

        }

        document.getElementById("doorstep").onclick = function() {

            document.getElementById("garden-plants").style.display = "none";
            document.getElementById("windowsill-plants").style.display = "none";
            document.getElementById("balcony-plants").style.display = "none";
            document.getElementById("doorstep-plants").style.display = "block";

        }
        document.getElementById("windowsill").onclick = function() {

            document.getElementById("garden-plants").style.display = "none";
            document.getElementById("doorstep-plants").style.display = "none";
            document.getElementById("balcony-plants").style.display = "none";
            document.getElementById("windowsill-plants").style.display = "block";
        ...
        document.getElementById("balcony").onclick = function() {
            ...
            document.getElementById("doorstep-plants").style.display = "none";
            document.getElementById("windowsill-plants").style.display = "none";
            document.getElementById("balcony-plants").style.display = "block";
