...
<header>
    ...
    <main>
        ...
        <div id="main-div">
            ...
            <div id="outdoor-light-img">
                ...
                <h1 id="page-label">Plants Lighting</h1>

            </div>

            <!-- sections icons -->
            <div id="icons" style="width: 24%;">
                <div class="iconscontainer outdoor-icons" id="sunlight">
                    <img src="../img/sunlight.png "alt="The image dose not appear ,possibilty because of slow connection"  class="imgs ">
                    <div class="hovering">
                        <div class="section-name" id="sun">Sunlight</div>
                    </div>
                </div>
                <div class=" iconscontainer outdoor-icons" id="shade">
                    <img src="../img/shade.png " alt="The image dose not appear ,possibilty because of slow connection" class="imgs ">
                    <div class="hovering">
                        <div class="section-name">Shade</div>
                    </div>
                </div>
            </div>
        ...
        <div id="sunlight-plants" class="sunlight-plants">
            <h3 class="section-label">Sunlight plants</h3>
            <br>
        ...
        <div id="shade-plants" class="shade-plants">
            <h3 class="section-label">Shade plants</h3>
            <br>
            <div class="products-section">
                <br>
                <div class="product">
    ...
    <footer class="footerparts ">
        ...
        <img class="imgfooter"  alt="The image dose not appear ,possibilty because of slow connection" src="../img/casual-life-3d-likes.png" height="40%" width="60%">
    ...
    <script type="text/javascript">
        document.getElementById("sun").onclick = function() {
            ...
            //document.getElementById("all-plants").style.display = "none";
            document.getElementById("shade-plants").style.display = "none";
            document.getElementById("sunlight-plants").style.display = "block";

        }

        document.getElementById("shade").onclick = function() {
            //document.getElementById("all-plants").style.display = "none";
            document.getElementById("sunlight-plants").style.display = "none";
            document.getElementById("shade-plants").style.display = "block";

        }

        document.getElementById("outdoor-light-img").onclick = function() {
            //document.getElementById("shade-plants").style.display = "none";
            document.getElementById("sunlight-plants").style.display = "none";
            document.getElementById("all-plants").style.display = "block";
